...
**The system also includes a self-healing capability that allows capable AI models to fix their own code in a safe sandbox environment.**
...
**See Also [MAi-INSTALLATION.md](MAi-INSTALLATION.md) for a detailed list of troubleshooting issues**

### Quick Fixes

| Issue | Solution |
|-------|----------|
| MAi-RAG-PA won't start | Is Ollama running? Verify Python 3.12+. Check Node.js 20+. Run System Doctor |
...
The frontend automatically retrieves your API key on first load. You don't need to do anything.
