...
class ModelManager:
    ...
    def get_context_config(self, hardware_tier: str = "medium") -> dict:
        """Returns safe context window and RAG limits based on hardware tier."""
        configs = {
            "high": {"num_ctx": 16384, "rag_limit": 8},
            "medium": {"num_ctx": 8192, "rag_limit": 5},
            "low": {"num_ctx": 4096, "rag_limit": 3},
            "minimal": {"num_ctx": 2048, "rag_limit": 2},
        }
        return configs.get(hardware_tier.lower(), configs["medium"])
