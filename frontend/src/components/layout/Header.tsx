...
const Header: React.FC<HeaderProps> = ({ onNavigate, showToast }) => {
  ...
  const handleStopSystem = async () => {
    if (
      !window.confirm(
        'Are you sure you want to stop MAi-RAG? All services will be shut down.'
      )
    ) {
      return;
    }
      ...
      >
        ...
        >
          <a
            ...
            aria-label="MAi-RAG Home - Return to top of page"
            style={{
              display: 'flex',
              alignItems: 'center',
              cursor: 'pointer',
          ...
          {!isMobile && (
            ...
            >
              <a href="#console" onClick={(e) => handleClick(e, 'console')} style={navLinkStyle}>
                Chat Console
              </a>
              <a href="#notes" onClick={(e) => handleClick(e, 'notes')} style={navLinkStyle}>
                Text Editor
              </a>
              <a href="#memory" onClick={(e) => handleClick(e, 'memory')} style={navLinkStyle}>
                Memory
              </a>
              <a href="#planner" onClick={(e) => handleClick(e, 'planner')} style={navLinkStyle}>
                Calendar Planner
              </a>
              <a href="#settings" onClick={(e) => handleClick(e, 'settings')} style={navLinkStyle}>
                Assistant Settings
              </a>
            </nav>
          )}
              ...
              aria-label={
                isProcessing
                  ? systemStatus === 'running'
                    ? 'Stopping MAi-RAG services, please wait'
                    : 'Starting MAi-RAG services, please wait'
                  : systemStatus === 'running'
                    ? 'Stop MAi-RAG services'
                    : 'Start MAi-RAG services'
              }
